"""Fourier-mode density estimation for the parabolic-parabolic KS injection run.

Vendored verbatim from the working prototype
(Numerical_experiment/multispecies_injection/density.py) so this experiment
directory has NO cross-directory imports.  Builds a smooth Fourier reconstruction
of an empirical particle measure on the torus and a differentiable point
evaluator used for the chemotactic drift grad v.
"""
import numpy as np

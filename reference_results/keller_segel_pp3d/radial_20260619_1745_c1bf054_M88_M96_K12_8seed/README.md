...
**The critical mass is bandwidth-dependent** (see `../PILOT_FINDINGS_msweep.md`):
M\*≈(88,92] at K=8 but M\*∈(72,80] at the production bandwidth K=12. Configs were
therefore re-selected AT K=12.

## Run directories (label_chiX_NX_KX_tauX_seedX/)

| label | M | role | N | seeds | R_0.5(T)/R_0.5(0) |
|-------|---|------|---|-------|-------------------|
| `weak`        | 72 | sub-critical, diffusive (Fig B panel c) | 100000 | 0–7 | **3.75** (expands) |
| `delayed`     | 96 | super-critical, delayed focusing (panels a,b,c,d) | 100000 | 0–7 | **0.21** (focuses) |
...
- **Weak vs delayed contrast (panel c)**: M=72 diffuses (R_0.5 →2.60, ratio 3.75 monotone,
  ...
  across the K=12 critical mass. Delay is genuine: M=96 max R_0.5/R_0.5(0)≈1.26 (cloud
